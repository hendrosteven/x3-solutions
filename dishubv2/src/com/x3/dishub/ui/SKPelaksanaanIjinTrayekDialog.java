 ...
 */
public class SKPelaksanaanIjinTrayekDialog extends javax.swing.JDialog {

    private WarnaDAO wDao = (WarnaDAO) MainApps.appContext.getBean("warnaDAO");
    private Warna headerColor;
    private Warna backgroudColor;
    private SkPelaksanaanIjinTrayekDAO dao = (SkPelaksanaanIjinTrayekDAO) MainApps.appContext.getBean("skPelaksanaanIjinTrayekDAO");
    private List<SkPelaksanaanIjinTrayek> list;
    private SkPelaksanaanIjinTrayek selected;
    ...
    public SKPelaksanaanIjinTrayekDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void loadWarna() {
        headerColor = wDao.getByNama("SKPelaksanaanIjinTrayekDialogHd");
        if (headerColor == null) {
            headerColor = new Warna();
            headerColor.setName("SKPelaksanaanIjinTrayekDialogHd");
            headerColor.setRgb(-16777012);
            wDao.insert(headerColor);
            loadWarna();
        }
        backgroudColor = wDao.getByNama("SKPelaksanaanIjinTrayekDialogBg");
        if (backgroudColor == null) {
            backgroudColor = new Warna();
            backgroudColor.setName("SKPelaksanaanIjinTrayekDialogBg");
    ...
    private void bindTabel() {
        try {
            String title[] = {"No.SK Pelasanaan", "Tgl SK", "No.Ijin Trayek", "Masa Berlaku Ijin Trayek", "Perusahaan"};
            Object[][] data = new Object[list.size()][5];
            int row = 0;
            for (SkPelaksanaanIjinTrayek sk : list) {
                data[row][0] = sk.getNomor();
                data[row][1] = formater.format(sk.getTanggal());
                data[row][2] = sk.getIjinTrayek().getNomor();
                data[row][3] = sk.getIjinTrayek().getMasaBerlakuMulai() + " s/d "
                        + sk.getIjinTrayek().getMasaBerlakuSelesai();
                data[row][4] = sk.getIjinTrayek().getPerusahaan().getNama();
                ++row;
            }
    ...
    private void initComponents() {
        ...
        btnSimpanSk = new javax.swing.JButton();
        btnBuatSk = new javax.swing.JButton();
        btnHapusSk = new javax.swing.JButton();
        txtIjinTrayek = new javax.swing.JTextField();
        btnBrowseIjinTrayek = new javax.swing.JButton();
        ...
        jLabel8.setText("Daftar Ijin Trayek");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Pilih Ijin Trayek untuk SK Pelaksanaan");
        ...
        setTitle("SK Pelaksanaan Ijin Trayek");
        ...
        jLabel1.setText("SK Pelaksanaan Ijin Trayek");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Pembuatan SK Pelaksanaan Ijin Trayek Taksi ");
        ...
        tabpane.addTab("Daftar SK Pelaksanaan Ijin Trayek", jPanel2);

        jLabel3.setText("Nomor :");

        jLabel5.setText("Tanggal :");

        jLabel6.setText("Ijin Trayek :");

        btnSimpanSk.setText("Simpan");
        btnSimpanSk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSimpanSkActionPerformed(evt);
            }
        });

        btnBuatSk.setText("Buat Baru");
        btnBuatSk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuatSkActionPerformed(evt);
            }
        });

        btnHapusSk.setText("Hapus");
        btnHapusSk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnHapusSkActionPerformed(evt);
            }
        });

        txtIjinTrayek.setEditable(false);

        btnBrowseIjinTrayek.setText("....");
        btnBrowseIjinTrayek.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBrowseIjinTrayekActionPerformed(evt);
            }
        });
        ...
        btnCetak.setText("Cetak SK Pelaksanaan Ijin Trayek");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(btnHapusSk)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnBuatSk)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnSimpanSk))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(85, 85, 85)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel4Layout.createSequentialGroup()
                                    .addComponent(txtIjinTrayek, javax.swing.GroupLayout.PREFERRED_SIZE, 314, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(btnBrowseIjinTrayek, 0, 0, Short.MAX_VALUE)))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnBrowseIjinTrayek))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
        ...
        tabpane.addTab("Detai SK Pelaksanaan Ijin Trayek / Buat Baru", jPanel3);

        jMenu1.setText("Seting");
    ...
    private void tblSKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSKMouseClicked
        ...
        txtPerusahaan.setText(selected.getIjinTrayek().getPerusahaan().getNama());
        loadArmada();
    }//GEN-LAST:event_tblSKMouseClicked

    private void btnBrowseIjinTrayekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowseIjinTrayekActionPerformed
        try {
    ...
    }//GEN-LAST:event_btnBrowseIjinTrayekActionPerformed
    ...
    private void btnSimpanSkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanSkActionPerformed
        try {
            if (!txtNomor.getText().isEmpty() && ijin != null) {
                if (selected == null) {
                    SkPelaksanaanIjinTrayek sk = new SkPelaksanaanIjinTrayek();
                    sk.setNomor(txtNomor.getText());
                    sk.setTanggal(tglSk.getDate());
                    sk.setIjinTrayek(ijin);
    ...
    }//GEN-LAST:event_btnSimpanSkActionPerformed

    private void btnBuatSkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuatSkActionPerformed
        ijin = null;
        selected = null;
        txtNomor.setText("");
        tglSk.setDate(new Date());
    ...
    }//GEN-LAST:event_btnBuatSkActionPerformed

    private void btnHapusSkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusSkActionPerformed
        try {
            if (selected != null) {
                dao.delete(selected);
                selected = null;
    ...
    }//GEN-LAST:event_btnHapusSkActionPerformed
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        try {
            if (selected != null) {
                ...
                JasperPrint print = JasperFillManager.fillReport("print/skPelaksanaanIjinTrayek.jasper",
                        mp, ds.getConnection());
    ...
    private void btnCetakLampiranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakLampiranActionPerformed
        try {
            if (selected != null) {
                ...
                DataSource ds = (DataSource) MainApps.appContext.getBean("dataSource");
                JDialog printView = new JDialog();
                JasperPrint print = JasperFillManager.fillReport("print/lampiranSkPelaksanaanIjinTrayek.jasper",
                        mp, ds.getConnection());
                JRViewer viewer = new JRViewer(print);
                printView.getContentPane().add(viewer);
                printView.setModal(false);
    ...
    private javax.swing.JButton btnBrowseIjinTrayek;
    private javax.swing.JButton btnBrowseKendaraan;
    private javax.swing.JButton btnBuatSk;
