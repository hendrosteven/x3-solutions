 ...
 */
public class SpitDialog extends javax.swing.JDialog {

    private WarnaDAO wDao = (WarnaDAO) MainApps.appContext.getBean("warnaDAO");
    private Warna headerColor;
    private Warna backgroudColor;
    private SpitDAO dao = (SpitDAO) MainApps.appContext.getBean("spitDAO");
    private List<Spit> list;
    private Spit selected;
    ...
    public SpitDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void loadWarna() {
        headerColor = wDao.getByNama("SpitDialogHd");
        if (headerColor == null) {
            headerColor = new Warna();
            headerColor.setName("SpitDialogHd");
            headerColor.setRgb(-16777012);
            wDao.insert(headerColor);
            loadWarna();
        }
        backgroudColor = wDao.getByNama("SpitDialogBg");
        if (backgroudColor == null) {
            backgroudColor = new Warna();
            backgroudColor.setName("SpitDialogBg");
    ...
    private void initComponents() {
        ...
        setTitle("Surat Persetujuan Ijin Trayek");
        ...
        jLabel1.setText("Surat Persetujuan Ijin Trayek (SPIT)");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Pembuatan SPIT");
        ...
        tblSpit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblSpitMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblSpit);
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtLainLain, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
    ...
    private void tblSpitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSpitMouseClicked
        selected = list.get(tblSpit.getSelectedRow());
    ...
    }//GEN-LAST:event_tblSpitMouseClicked
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            if (selected != null) {
                ...
                txtLainLain.setText("");
                loadSpit();
                JOptionPane.showMessageDialog(this, "Date terhapus");
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        try {
            if (selected != null) {
                ...
                JasperPrint print = JasperFillManager.fillReport("print/spit.jasper",
                        mp, ds.getConnection());
                JRViewer viewer = new JRViewer(print);
                printView.getContentPane().add(viewer);
                printView.setModal(false);
                printView.setTitle("Print SPIT");
