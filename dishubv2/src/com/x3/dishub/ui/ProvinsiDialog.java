 ...
 */
public class ProvinsiDialog extends javax.swing.JDialog {

    private ProvinsiDAO dao = (ProvinsiDAO) MainApps.appContext.getBean("provinsiDAO");
    private Provinsi selected;
    private List<Provinsi> list;

    /** Creates new form MerkDialog */
    public ProvinsiDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void loadTable() {
        try {
            list = dao.getAllProvinsi();
            String title[] = {"Kode","Nama Provinsi"};
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Menambah, mengubah dan menghapus data provinsi");
