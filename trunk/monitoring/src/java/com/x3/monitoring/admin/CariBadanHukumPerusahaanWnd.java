 ...
 */
public class CariBadanHukumPerusahaanWnd extends ApplicationContext {

    Combobox cmbBadanHukum;
    Listbox lstHasil;

    public CariBadanHukumPerusahaanWnd() {
    }
    ...
    public void onCreate() throws Exception {
        ...
        loadBadanHukum();
        cmbBadanHukum.setSelectedIndex(0);
    }
    ...
    public void cari() throws Exception {
        ...
        try {
            ...
            List<Perusahaan> list = dao.gets((BadanHukum) cmbBadanHukum.getSelectedItem().getValue());
    ...
    public void cetak() throws Exception {
        ...
        BadanHukum bh = (BadanHukum) cmbBadanHukum.getSelectedItem().getValue();
        sql.setValue("SELECT * FROM perusahaan WHERE badan_hukum_id=" + bh.getId());
        win.doModal();
    }
}
