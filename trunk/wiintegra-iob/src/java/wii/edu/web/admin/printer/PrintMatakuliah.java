 ...
 * @author Retha@wii
 */
public class PrintMatakuliah extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(request.getParameter("idFakultas") == null || request.getParameter("idFakultas").equals("")){
                listMatkul = new MatakuliahDAO().getAllMatakuliahMinus();
                ...
                listMatkul = new MatakuliahDAO().getAllMatakuliah(fakultas);
                parameters.put("fakultas", fakultas.getNama());
            }

            JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(listMatkul);
            System.out.println("1 " + getServletContext().getRealPath("report/admin/matakuliah.jrxml"));
            // Compile JRXML menjadi Jasper
            JasperReport jasperReport = JasperCompileManager.compileReport(getServletContext().getRealPath("report/admin/matakuliah.jrxml"));
