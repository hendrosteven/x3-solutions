 ...
 * @author Retha@wii
 */
public class PrintCuti extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String namaSemester = request.getParameter("semester");
            ...
            parameters.put("fakultas", mhs.getFakultas().getNama());
            ...
            System.out.println("1 " + getServletContext().getRealPath("report/akademik/cuti.jrxml"));
            // Compile JRXML menjadi Jasper
            JasperReport jasperReport = JasperCompileManager.compileReport(getServletContext().getRealPath("report/akademik/cuti.jrxml"));
