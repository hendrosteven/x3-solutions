 ...
 * @author Retha@wii
 */
public class PrintTranskripAction extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            List<RegistrasiMatakuliah> listMatkul = dao.getAllMatakuliahIPK(mhs, semester);
            ...
            if(listMatkul.size() == 0){
                ...
                for(int i=0;i<listMatkul.size();i++) {
                    double BobotNilai=0;
                    if(listMatkul.get(i).getNilai()!=null) {
                        if(listMatkul.get(i).getNilai().equals("A")) {
                            BobotNilai=4;
                        } else if(listMatkul.get(i).getNilai().equals("B")) {
                            BobotNilai=3;
                        } else if(listMatkul.get(i).getNilai().equals("C")) {
                            BobotNilai=2;
                        } else if(listMatkul.get(i).getNilai().equals("D")) {
                            BobotNilai=1;
                        }
                        for(int j=i-1;j>=0;j--) {
                            if(j<0) {
                            ...
                            if(listMatkul.get(i).getMatakuliah().getId()==listMatkul.get(j).getMatakuliah().getId()) {
                                double oldBobotNilai=0;
                                if(listMatkul.get(j).getNilai()!=null) {
                                    if(listMatkul.get(j).getNilai().equals("A")) {
                                        oldBobotNilai=4;
                                    } else if(listMatkul.get(j).getNilai().equals("B")) {
                                        oldBobotNilai=3;
                                    } else if(listMatkul.get(j).getNilai().equals("C")) {
                                        oldBobotNilai=2;
                                    } else if(listMatkul.get(j).getNilai().equals("D")) {
                                        oldBobotNilai=1;
                                    }
                                }
            ...
            Logger.getLogger(PrintTranskripAction.class.getName()).log(Level.SEVERE, null, ex);
