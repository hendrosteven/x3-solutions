 ...
 * @author Retha@wii
 */
public class PrintMahasiswaUnreg extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(request.getParameter("idFakultas") == null || request.getParameter("idFakultas").equals("")){
                listMhs = new PembayaranDAO().getAllMahasiswaTerregistrasi(semester);
                hasil = new PembayaranDAO().countTerregistrasi(semester);
                ...
                listMhs = new PembayaranDAO().getAllMahasiswaTerregistrasi(semester, fakultas);
                hasil = new PembayaranDAO().countTerregistrasi(semester, fakultas);
            ...
            parameters.put("judul", "DAFTAR MAHASISWA YANG TELAH TERREGISTRASI");
