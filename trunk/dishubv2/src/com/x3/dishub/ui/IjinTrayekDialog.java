 ...
 */
public class IjinTrayekDialog extends javax.swing.JDialog {

    private WarnaDAO wDao = (WarnaDAO) MainApps.appContext.getBean("warnaDAO");
    private Warna headerColor;
    private Warna backgroudColor;
    private IjinTrayekDAO dao = (IjinTrayekDAO) MainApps.appContext.getBean("ijinTrayekDAO");
    private List<IjinTrayek> list;
    private IjinTrayek selected;
    private SimpleDateFormat formater = new SimpleDateFormat("dd/MM/yyyy");
    private PerusahaanDAO pDao = (PerusahaanDAO) MainApps.appContext.getBean("perusahaanDAO");
    private SpitDAO sDao = (SpitDAO) MainApps.appContext.getBean("spitDAO");
    ...
    public IjinTrayekDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void loadWarna() {
        headerColor = wDao.getByNama("IjinTrayekDialogHd");
        if (headerColor == null) {
            headerColor = new Warna();
            headerColor.setName("IjinTrayekDialogHd");
            headerColor.setRgb(-16777012);
            wDao.insert(headerColor);
            loadWarna();
        }
        backgroudColor = wDao.getByNama("IjinTrayekDialogBg");
        if (backgroudColor == null) {
            backgroudColor = new Warna();
            backgroudColor.setName("IjinTrayekDialogBg");
    ...
    private void initComponents() {
        ...
        cariDialog = new javax.swing.JDialog();
        ...
        cmbSpit = new javax.swing.JComboBox();
        ...
        cariDialog.setBounds(new java.awt.Rectangle(0, 0, 100, 100));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Pilih Tanggal Masa Berakhir Ijin Trayek");

        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Mulai Tanggal :");

        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Sampai Tanggal :");
        ...
        cariDialogLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, cariDialogLayout.createSequentialGroup()
                .addContainerGap(271, Short.MAX_VALUE)
                .addComponent(btnCari)
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, cariDialogLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(cariDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(tglCariMulai, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                    .addComponent(tglCariSelesai, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
        ...
        jLabel1.setText("Ijin Trayek");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Pembuatan Ijin Trayek Angkutan Umum ");
        ...
        tabpane.addTab("Daftar Ijin Trayek", jPanel2);
        ...
        jLabel6.setText("Berdasar Pada SPIT :");

        jLabel7.setText("Nomor Surat Permohonan :");

        jLabel8.setText("Tanggal Surat Permohonan :");

        cmbSpit.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        btnCetak.setText("Cetak Ijin Trayek");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(tglBerlakuMulai, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(12, 12, 12)
                                .addComponent(jLabel9)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tglBerlakuAkhir, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(txtNoSuratPermohonan, javax.swing.GroupLayout.PREFERRED_SIZE, 381, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(cmbSpit, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(cmbPerusahaan, javax.swing.GroupLayout.Alignment.LEADING, 0, 429, Short.MAX_VALUE)))
                        .addGap(226, 226, 226))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmbSpit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblArmada.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nomor Polisi", "Nomor Uji", "Merk / Type", "Tahun", "Daya Angkut", "Trayek"
            }
        ));
        ...
        tabpane.addTab("Detail Ijin Trayek / Buat Baru", jPanel3);
    ...
    private void btnCariTanggalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariTanggalActionPerformed
        ...
        cariDialog.getContentPane().setBackground(new java.awt.Color(51, 102, 255));
        cariDialog.setSize(350, 250);
        cariDialog.setModal(true);
    ...
    private void loadSpit() {
        try {
            cmbSpit.removeAllItems();
            for (Spit s : sDao.getAllSpit()) {
                cmbSpit.addItem(s);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
    ...
    private int getCmbSpitIndex(Spit s) {
        int index = 0;
        for (Spit tmp : sDao.getAllSpit()) {
    ...
    private void tblIjinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblIjinMouseClicked
        ...
        cmbSpit.setSelectedIndex(getCmbSpitIndex(selected.getSpit()));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        try {
            if (!txtNomor.getText().isEmpty() && !txtNoSuratPermohonan.getText().isEmpty()
                    && cmbPerusahaan.getSelectedItem() != null && cmbSpit.getSelectedItem() != null) {
                if (selected == null) {
                    IjinTrayek i = new IjinTrayek();
                    ...
                    i.setSpit((Spit) cmbSpit.getSelectedItem());
                    ...
                    selected.setSpit((Spit) cmbSpit.getSelectedItem());
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        try {
            if (selected != null) {
                ...
                JasperPrint print = JasperFillManager.fillReport("print/ijinTrayek.jasper",
                        mp, ds.getConnection());
    ...
    private void btnCetakLampiranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakLampiranActionPerformed
        try {
            if (selected != null) {
                ...
                DataSource ds = (DataSource) MainApps.appContext.getBean("dataSource");
                JDialog printView = new JDialog();
                JasperPrint print = JasperFillManager.fillReport("print/lampiranIjinTrayek.jasper",
                        mp, ds.getConnection());
                JRViewer viewer = new JRViewer(print);
                printView.getContentPane().add(viewer);
                printView.setModal(false);
    ...
    private javax.swing.JComboBox cmbSpit;
