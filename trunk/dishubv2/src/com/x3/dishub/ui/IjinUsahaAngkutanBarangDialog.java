 ...
 */
public class IjinUsahaAngkutanBarangDialog extends javax.swing.JDialog {

    private WarnaDAO wDao = (WarnaDAO) MainApps.appContext.getBean("warnaDAO");
    private Warna headerColor;
    private Warna backgroudColor;
    private IjinUsahaAngkutanBarangDAO dao = (IjinUsahaAngkutanBarangDAO) MainApps.appContext.getBean("ijinUsahaAngkutanBarangDAO");
    private PerusahaanDAO pDao = (PerusahaanDAO) MainApps.appContext.getBean("perusahaanDAO");
    private List<IjinUsahaAngkutanBarang> list;
    private IjinUsahaAngkutanBarang selected;
    private SimpleDateFormat formater = new SimpleDateFormat("dd/MM/yyyy");

    /** Creates new form IjinUsahaAngkutanOrangDialog */
    public IjinUsahaAngkutanBarangDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void loadWarna() {
        headerColor = wDao.getByNama("IjinUsahaAngkutanBarangDialogHd");
        if (headerColor == null) {
            headerColor = new Warna();
            headerColor.setName("IjinUsahaAngkutanBarangDialogHd");
            headerColor.setRgb(-16777012);
            wDao.insert(headerColor);
            loadWarna();
        }
        backgroudColor = wDao.getByNama("IjinUsahaAngkutanBarangDialogBg");
        if (backgroudColor == null) {
            backgroudColor = new Warna();
            backgroudColor.setName("IjinUsahaAngkutanBarangDialogBg");
    ...
    private void loadIjin() {
        try {
            list = dao.getAllIjinUsahaAngkutanBarang();
    ...
    private void initComponents() {
        ...
        setTitle("Ijin Usaha Angkutan Barang");
        ...
        jLabel1.setText("Ijin Usaha Angkutan Barang");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Pembuatan Ijin Usaha Angkutan barang");
    ...
    private void tblIjinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblIjinMouseClicked
        ...
        tglPermohonan.setDate(selected.getTanggalSuratPermohonan());
        ...
        try {
            if (!txtNomor.getText().isEmpty() && !txtNomorPermohonan.getText().isEmpty()) {
                if (selected == null) {
                    ...
                    selected.setTanggalSuratPermohonan(tglPermohonan.getDate());
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        try {
            if (selected != null) {
                ...
                JasperPrint print = JasperFillManager.fillReport("print/ijinUsahaBarang.jasper",
                        mp, ds.getConnection());
