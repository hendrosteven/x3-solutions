 ...
 * @author Retha@wii
 */
public class PrintRuang extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            JasperReport jasperReport = JasperCompileManager.compileReport(getServletContext().getRealPath("report/admin/ruang.jrxml"));
