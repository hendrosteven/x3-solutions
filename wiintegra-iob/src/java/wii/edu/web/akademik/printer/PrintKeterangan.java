 ...
 * @author Retha@wii
 */
public class PrintKeterangan extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("1 " + getServletContext().getRealPath("report/akademik/keterangan_kuliah.jrxml"));
            // Compile JRXML menjadi Jasper
            JasperReport jasperReport = JasperCompileManager.compileReport(getServletContext().getRealPath("report/akademik/keterangan_kuliah.jrxml"));
