 ...
 * @author Retha@wii
 */
public class PrintMahasiswa extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(request.getParameter("idFakultas") == null || request.getParameter("idFakultas").equals("")){
                listMhs = new MahasiswaDAO().getAllMahasiswaBelumLulus();
                iter = new MahasiswaDAO().countBelumLulus();
                ...
                listMhs = new MahasiswaDAO().getAllMahasiswa(fakultas);
                iter = new MahasiswaDAO().countBelumLulus(fakultas);
