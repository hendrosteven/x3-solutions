 ...
 * @author Retha@wii
 */
public class IpkJSON extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(task.equals("MAHASISWA")){
                ...
                output = dao.getAllMatakuliahIPKJSONObject(mahasiswa,semester).toString();
            ...
            Logger.getLogger(IpkJSON.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    } 
