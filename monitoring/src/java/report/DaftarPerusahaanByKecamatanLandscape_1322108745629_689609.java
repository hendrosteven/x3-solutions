/*
 * Generated by JasperReports - 11/24/11 11:25 AM
 */
 ...
 *
 */
public class DaftarPerusahaanByKecamatanLandscape_1322108745629_689609 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 14 : 
            {
                value = (java.lang.String)("DATA PERUSAHAAN KOTA SALATIGA TAHUN "+ (Calendar.getInstance().get(Calendar.YEAR)));//$JR_EXPR_ID=14$
                break;
            }
            case 15 : 
            {
                value = (java.lang.String)(((java.lang.String)field_nama_kec.getValue()));//$JR_EXPR_ID=15$
                break;
            }
            case 16 : 
            {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 15 : 
            {
                value = (java.lang.String)(((java.lang.String)field_nama_kec.getOldValue()));//$JR_EXPR_ID=15$
                break;
            }
            case 16 : 
            {
