 ...
 */
public class CariStatusPerusahaanWnd extends ApplicationContext {

    Combobox cmbStatusPerusahaan;
    Listbox lstHasil;

    public CariStatusPerusahaanWnd() {
    }
    ...
    public void onCreate() throws Exception {
        ...
        cmbStatusPerusahaan.setSelectedIndex(0);
    }
     ...
     public void cari() throws Exception {
        ...
        try {
            ...
            List<Perusahaan> list = dao.gets((StatusPerusahaan)cmbStatusPerusahaan.getSelectedItem().getValue());
    ...
    public void cetak() throws Exception {
        ...
        StatusPerusahaan sp = (StatusPerusahaan) cmbStatusPerusahaan.getSelectedItem().getValue();
        sql.setValue("SELECT * FROM perusahaan WHERE status_perusahaan_id=" + sp.getId());
        win.doModal();
    }
}
