 ...
 */
public class CariNamaPerusahaanWnd extends ApplicationContext {

    Textbox txtKeyWord;
    Listbox lstHasil;

    public CariNamaPerusahaanWnd() {
    }

    public void onCreate() throws Exception {
        txtKeyWord = (Textbox) getFellow("txtKeyWord");
    ...
    public void cari() throws Exception {
        ...
        try {
            ...
            List<Perusahaan> list = dao.gets(txtKeyWord.getValue());
    ...
    public void cetak() throws Exception {
        ...
        sql.setValue("SELECT * FROM perusahaan WHERE nama_perusahaan LIKE '%"+txtKeyWord.getValue()+"%'");
        win.doModal();
    }
}
